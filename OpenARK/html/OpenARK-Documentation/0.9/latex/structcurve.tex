...
\index{curve@{curve}!calculate@{calculate}}
\index{calculate@{calculate}!curve@{curve}}
...
\index{curve@{curve}!average\+Angle@{average\+Angle}}
\index{average\+Angle@{average\+Angle}!curve@{curve}}
...
\index{curve@{curve}!centroid@{centroid}}
\index{centroid@{centroid}!curve@{curve}}
...
\index{curve@{curve}!g@{g}}
\index{g@{g}!curve@{curve}}
...
\index{curve@{curve}!max\+Angle@{max\+Angle}}
\index{max\+Angle@{max\+Angle}!curve@{curve}}
